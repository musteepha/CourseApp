...
namespace CoursesWebApp.Models
{
    public class DataAccessController
    {
        ...
        private string connectionString = "Server=tcp:courseserver357.database.windows.net,1433;Initial Catalog=coursedatabase357;Persist Security Info=False;User ID=thanossql;Password=B3@n5&pl@nt@1n20;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
